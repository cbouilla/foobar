...
#line 73 "quadratic_v1.nw"
	printf("[%.1f] task launch\n", wtime());
	
#line 127 "quadratic_v1.nw"
u64 *slice[3];
u32 size[3];
for (int kind = 0;  kind < 3; kind++) {	
	
#line 137 "quadratic_v1.nw"
char filename[255];
char *kind_name[3] = {"foo", "bar", "foobar"};
sprintf(filename, "%s/%s.%03x", hash_dir, kind_name[kind], task->idx[kind]);


#line 131 "quadratic_v1.nw"
	
#line 148 "quadratic_v1.nw"
struct stat infos;
...
#line 132 "quadratic_v1.nw"
	
#line 158 "quadratic_v1.nw"
...
#line 133 "quadratic_v1.nw"
}


#line 75 "quadratic_v1.nw"
	
#line 188 "quadratic_v1.nw"
u32 l = floor(log2(size[0] / 1024));
u32 grid_size = 1 << l;

#line 76 "quadratic_v1.nw"
	
#line 214 "quadratic_v1.nw"
...
#line 77 "quadratic_v1.nw"
	if (verbose) {
		
#line 234 "quadratic_v1.nw"
	/* task-level */
...
#line 79 "quadratic_v1.nw"
	}
	
#line 271 "quadratic_v1.nw"
...
#line 81 "quadratic_v1.nw"
	printf("[%.1f] task launch\n", wtime());
	for (u32 u = 0; u < grid_size; u++)
		process_block(&self, u, verbose);
	
#line 178 "quadratic_v1.nw"
for (u32 kind = 0;  kind < 3; kind++) {
	free(slice[kind]);
}

#line 85 "quadratic_v1.nw"
	printf("[%.1f] task stop\n", wtime());
	return result;
}
